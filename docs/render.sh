...
-framerate 10 -loop 1 -t 1.5 -i hippocampus.5.inference.png \
-filter_complex \
"[1]format=rgba,fade=d=0.3:t=in:alpha=1,setpts=PTS-STARTPTS+2/TB[f0]; \
 [2]format=rgba,fade=d=0.3:t=in:alpha=1,setpts=PTS-STARTPTS+4/TB[f1]; \
 [3]format=rgba,fade=d=0.3:t=in:alpha=1,setpts=PTS-STARTPTS+6/TB[f2]; \
 [4]format=rgba,fade=d=0.3:t=in:alpha=1,setpts=PTS-STARTPTS+8/TB[f3]; \
 [5]format=rgba,fade=d=0.3:t=in:alpha=1,setpts=PTS-STARTPTS+10/TB[f4]; \
 [0][f0]overlay[bg1]; \
 [bg1][f1]overlay[bg2]; \
 [bg2][f2]overlay[bg3]; \
 [bg3][f3]overlay[bg4]; \
